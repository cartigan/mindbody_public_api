...
module MindbodyPublicApi
  # AddSiteClientIndexRequest Model.
  class AddSiteClientIndexRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(client_index_name = nil, active = SKIP,
                   show_on_new_client = SKIP, show_on_enrollment_roster = SKIP,
    ...
    def self.from_hash(hash)
      ...
      AddSiteClientIndexRequest.new(client_index_name,
                                    active,
                                    show_on_new_client,
                                    show_on_enrollment_roster,
                                    edit_on_enrollment_roster,
