...
module MindbodyPublicApi
  ...
  class ClientMembership < BaseModel
    ...
    def self.names
      @_hash = {} if @_hash.nil?
      @_hash['restricted_locations'] = 'RestrictedLocations'
      @_hash['icon_code'] = 'IconCode'
    ...
    def initialize(restricted_locations = SKIP, icon_code = SKIP,
                   membership_id = SKIP, active_date = SKIP, count = SKIP,
                   current = SKIP, expiration_date = SKIP, id = SKIP,
                   product_id = SKIP, name = SKIP, payment_date = SKIP,
                   program = SKIP, remaining = SKIP, site_id = SKIP,
                   action = SKIP, client_id = SKIP, returned = SKIP)
      @restricted_locations = restricted_locations unless restricted_locations == SKIP
      @icon_code = icon_code unless icon_code == SKIP
    ...
    def self.from_hash(hash)
      ...
      restricted_locations = nil
      unless hash['RestrictedLocations'].nil?
        restricted_locations = []
        hash['RestrictedLocations'].each do |structure|
          restricted_locations << (Location.from_hash(structure) if structure)
        end
      end

      restricted_locations = SKIP unless hash.key?('RestrictedLocations')
      icon_code = hash.key?('IconCode') ? hash['IconCode'] : SKIP
      ...
      ClientMembership.new(restricted_locations,
                           icon_code,
                           membership_id,
                           active_date,
                           count,
