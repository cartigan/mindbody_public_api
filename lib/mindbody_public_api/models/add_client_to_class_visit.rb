...
module MindbodyPublicApi
  ...
  class AddClientToClassVisit < BaseModel
    ...
    # The business' ID of the type of pricing option used to pay for the class
    # visit.
    # @return [Integer]
    ...
    # @return [TrueClass | FalseClass]
    attr_accessor :cross_regional_booking_performed
    ...
    # waiting list for the requested class. The only additional fields that are
    # populated when this is not null are:
    # * ClassId
    # * ClientId
    # You can call GET WaitlistEntries using `WaitlistEntryId` to obtain more
    ...
    def self.names
      ...
      @_hash['action'] = 'Action'
      @_hash['cross_regional_booking_performed'] =
    ...
    def initialize(appointment_id = SKIP, appointment_gender_preference = SKIP,
                   ...
                   location_id = SKIP, make_up = SKIP, name = SKIP,
                   service_id = SKIP, service_name = SKIP, product_id = SKIP,
                   signed_in = SKIP, staff_id = SKIP, web_signup = SKIP,
                   action = SKIP, cross_regional_booking_performed = SKIP,
                   site_id = SKIP, waitlist_entry_id = SKIP)
      ...
      unless cross_regional_booking_performed == SKIP
        @cross_regional_booking_performed =
          cross_regional_booking_performed
      end
    ...
    def self.from_hash(hash)
      ...
      cross_regional_booking_performed =
        hash.key?('CrossRegionalBookingPerformed') ? hash['CrossRegionalBookingPerformed'] : SKIP
      site_id = hash.key?('SiteId') ? hash['SiteId'] : SKIP
      waitlist_entry_id =
        hash.key?('WaitlistEntryId') ? hash['WaitlistEntryId'] : SKIP

      # Create object from extracted values.
      AddClientToClassVisit.new(appointment_id,
                                appointment_gender_preference,
                                appointment_status,
                                class_id,
                                client_id,
