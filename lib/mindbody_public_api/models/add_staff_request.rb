...
module MindbodyPublicApi
  ...
  class AddStaffRequest < BaseModel
    ...
    def initialize(first_name = nil, last_name = nil, email = SKIP,
                   ...
                   sort_order = SKIP, provider_i_ds = SKIP, notes = SKIP,
                   emp_id = SKIP)
    ...
    def self.from_hash(hash)
      ...
      AddStaffRequest.new(first_name,
                          last_name,
                          email,
                          is_male,
                          home_phone,
