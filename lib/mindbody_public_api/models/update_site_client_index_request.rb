...
module MindbodyPublicApi
  # UpdateSiteClientIndexRequest Model.
  class UpdateSiteClientIndexRequest < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # The ID of the client index.
    # @return [Integer]
    ...
    def initialize(client_index_id = nil, client_index_name = nil,
    ...
    def self.from_hash(hash)
      ...
      client_index_id = hash.key?('ClientIndexID') ? hash['ClientIndexID'] : nil
      client_index_name =
        hash.key?('ClientIndexName') ? hash['ClientIndexName'] : nil
      ...
      UpdateSiteClientIndexRequest.new(client_index_id,
                                       client_index_name,
                                       active,
                                       show_on_new_client,
                                       show_on_enrollment_roster,
