...
module MindbodyPublicApi
  ...
  class GetClientsResponse < BaseModel
    ...
    # @return [Array[ClientWithSuspensionInfo]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['Clients'].nil?
        ...
        hash['Clients'].each do |structure|
          clients << (ClientWithSuspensionInfo.from_hash(structure) if structure)
        end
      end
      ...
      GetClientsResponse.new(pagination_response,
                             clients)
    end
  end
end
