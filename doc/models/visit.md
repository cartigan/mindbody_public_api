...
| `client_photo_url` | `String` | Optional | PhotoUrl for the client |
| `client_unique_id` | `Integer` | Optional | The unique ID of the client associated with the visit. |
...
| `site_id` | `Integer` | Optional | The ID of the business where the visit is booked. |
...
| `service_id` | `Integer` | Optional | The unique ID assigned to this pricing option when it was purchased by the client. |
| `service_name` | `String` | Optional | The name of the pricing option at the site where it was purchased. |
| `service` | [`ClientService`](../../doc/models/client-service.md) | Optional | A service that is on a client's account. |
| `product_id` | `Integer` | Optional | The ID of the pricing option at the site where it was purchased. |
...
| `missed` | `TrueClass \| FalseClass` | Optional | When `true`, indicates that the class has been `Missed`.<br /><br>When `false`, indicates that the class has not been `Missed`. |
| `visit_type` | `Integer` | Optional | Indicates the Id of visit type. |
| `type_group` | `Integer` | Optional | Indicates the Id of type group. |
| `type_taken` | `String` | Optional | Indicates the service type taken. |
